...
<html>
<head>
<title>Actor Portal Actor Register</title>
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="workexp">Year Range</label>
                <div class="col-md-9">
                    <select name="workexp" id="yearRange" class="form-control input-sm" required>
...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-3 grid_3">
			<h4>Who We Are!</h4>
			<p style="text-align:justify">We have a trusted relation with the employer and the actor seekers and we believe in maintaining that trust and relationship throughout. Our main aim is satisfied customers, be it employers or jobseekers.</p>
		</div>
		<div class="col-md-3 grid_3">
