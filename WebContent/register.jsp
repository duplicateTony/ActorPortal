...
<html>
<head>
<title>Actor Portal Register</title>
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        ...
        <h3>Actor Registration</h3>
        <p><button type="button" class="btn red" onclick="location.href='actorregister.jsp'">Register Now!</button></p>
        </div>
        <div class="col-md-6 grid_3 text-center about_bottom">
